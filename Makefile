...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ifeq ($(PLATFORM_OS),WINDOWS)
        ...
        ########## CFLAGS += $(RAYLIB_PATH)/src/raylib.rc.data  ###### aa file optional che aetle aa line comment kari che
    endif
    ifeq ($(PLATFORM_OS),LINUX)
...
# aahi multiple files appva mate aapde source badlisu if we have more files any other than our main files so we have to give all cpp's in the SRC 
SRC = main.cpp \
      core/Board.cpp \
      shapes/Shape.cpp \
      systems/Bag.cpp \
